...
-(void)rotate:(UIInterfaceOrientation)orientation animation:(BOOL)animation {
	...
	if (orientation == UIInterfaceOrientationPortrait || orientation == UIInterfaceOrientationPortraitUpsideDown) {
		if (view1 != nil) {
            int y = 2;
			[view1 setFrame:CGRectMake(0, y, super.frame.size.width/2, (super.frame.size.height/2)-GAP)];
            [view2 setFrame:CGRectMake(view1.frame.origin.x+view1.frame.size.width+GAP, y, (super.frame.size.width /2)-GAP, (super.frame.size.height/2)-GAP)];
            
            y = (super.frame.size.height/2)+GAP;
            [view3 setFrame:CGRectMake(0, y, super.frame.size.width /2, (super.frame.size.height/2)-GAP)];
            [view4 setFrame:CGRectMake(view3.frame.origin.x+view3.frame.size.width+GAP, y, (super.frame.size.width /2)-GAP, (super.frame.size.height/2)-GAP)];
		...
		if (view1 != nil) {
            ...
            [view2 setFrame:CGRectMake(view1.frame.origin.x+view1.frame.size.width+GAP, y, (super.frame.size.width/2)-GAP, (super.frame.size.height/2)-2)];

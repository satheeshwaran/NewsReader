...
-(void)rotate:(UIInterfaceOrientation)orientation animation:(BOOL)animation {
	...
	if (orientation == UIInterfaceOrientationPortrait || orientation == UIInterfaceOrientationPortraitUpsideDown) {
		if (view1 != nil) {
            int x = 0;
            [view1 setFrame:CGRectMake(x, 2, super.frame.size.width /2, (super.frame.size.height/3)-2)];
            ...
            [view4 setFrame:CGRectMake(x, 2, (super.frame.size.width /2)-GAP, (super.frame.size.height/2)-2)];
            [view5 setFrame:CGRectMake(x, view4.frame.origin.y+view4.frame.size.height+GAP, (super.frame.size.width /2)-GAP, (super.frame.size.height/2)-GAP)];
		...
		if (view1 != nil) {
            ...
            [view4 setFrame:CGRectMake(0, y, super.frame.size.width/2, (super.frame.size.height/2)-GAP)];
            [view5 setFrame:CGRectMake(view4.frame.origin.x+view4.frame.size.width+GAP, y, (super.frame.size.width/2)-GAP, (super.frame.size.height/2)-GAP)];

...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    if ([[UIDevice currentDevice] userInterfaceIdiom] == UIUserInterfaceIdiomPhone) {
        self.viewController = [[LNRMenuViewController alloc] initWithNibName:@"LNRMenuViewController_iPhone" bundle:nil];
    } else {
        self.viewController = [[LNRMenuViewController alloc] initWithNibName:@"LNRMenuViewController_iPad" bundle:nil];
    }
